...
export default function Sport({ sports }) {
  return (
    <div className="">
      {/* sports */}
      ...
      >
        ...
        <div className=" p-2 ">
          <h1 className="mb-1 text-center text-2xl font-bold">{sports.name}</h1>
        ...
        <div className="flex justify-center gap-5 pt-5 text-xl text-gray-700   ">
          ...
          <a href={sports.github} className="hover:text-red-600" target="_blank">
            {" "}
            <BsGithub />
          </a>
        </div>
