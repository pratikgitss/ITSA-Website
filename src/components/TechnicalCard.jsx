...
export default function Technical({ tech }) {
  return (
    <div className="">
      {/* Techical */}
      ...
      >
        <div className=" flex justify-center">
          <div className=" -mt-28 h-32 w-32 rounded-full   border-3 border-red-600 ">
            <LazyLoadImage
              src={tech.imageUrl ? tech.imageUrl : exe}
              alt={tech.name}
        ...
        <div className=" p-2 ">
          <h1 className="mb-1 text-center text-2xl font-bold">{tech.name}</h1>
        ...
        <div className="flex justify-center gap-5 pt-5 text-xl text-gray-700   ">
          ...
          <a href={tech.github} className="hover:text-red-600" target="_blank">
            {" "}
            <BsGithub />
          </a>
        </div>
